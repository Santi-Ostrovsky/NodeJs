...
Pueden descargar Postman para el sistema operativo que tengan desde aca: [https://www.postman.com/downloads/](https://www.postman.com/downloads/ "https://www.postman.com/downloads/")

### Instrucciones

Una vez instalado podrán acceder a la siguiente pantalla principal de Postman:

![Img](https://file+.vscode-resource.vscode-cdn.net/d%3A/SANTI/PROGRAMMING/HENRY/M-3/FT-M3-master/05-Express/homework/img/pantalla-inicial.png)
...
![Img](https://file+.vscode-resource.vscode-cdn.net/d%3A/SANTI/PROGRAMMING/HENRY/M-3/FT-M3-master/05-Express/homework/img/new-collection.png)
...
![Img](https://file+.vscode-resource.vscode-cdn.net/d%3A/SANTI/PROGRAMMING/HENRY/M-3/FT-M3-master/05-Express/homework/img/new-request.png)
...
- Indicar que tipo de Request queremos:
  ...
  - PUT
  - DELETE
- La URL sobre la cual vamos a realizar el request (En este caso será [http://localhost:3000/](http://localhost:3000/ "http://localhost:3000/"))
- Incluir los `Params` o el `Body` dependiendo del tipo de Request que hagamos
  ![Img](https://file+.vscode-resource.vscode-cdn.net/d%3A/SANTI/PROGRAMMING/HENRY/M-3/FT-M3-master/05-Express/homework/img/request-general.png)

Video demostrativo de cómo se utiliza y funcionan algunos request básicos de Postman:

![Img](https://file+.vscode-resource.vscode-cdn.net/d%3A/SANTI/PROGRAMMING/HENRY/M-3/FT-M3-master/05-Express/homework/img/video-request.gif)
